...
it('should return error data when passed valid arguments in Resources::error', function() {
	//
})->group('wp_brain_monkey')->skip('Feature implemented - !!!test not yet written!!!');

it('should return success data when passed valid arguments in Resources::success', function() {
	//
})->group('wp_brain_monkey')->skip('Feature implemented - !!!test not yet written!!!');
