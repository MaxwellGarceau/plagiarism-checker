...
<p>3. Fill in the fields and generate a new API token. <span class="plagiarism-checker__highlight">Use <code style="display: inline-block">https://example.com/</code> for your App Website URL.</span></p>
